/**
 * Página principal do Dashboard Gestor
 * Exibe estatísticas e ações rápidas para gestores
 */
...
import { Vote, FolderKanban, FileText, TrendingUp, Clock, CheckCircle } from 'lucide-react';
...
export default function DashboardGestorPage() {
  ...
  const loading = loadingSessoes || loadingProjetos || loadingVotos;
